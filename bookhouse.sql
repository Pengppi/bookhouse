...
CREATE TABLE `book`  (
  ...
  `book_author` varchar(80) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL,
  `book_kind` tinyint NULL DEFAULT NULL,
  `book_photo` varchar(80) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL,
  `book_publisher` varchar(80) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL,
  `book_version` varchar(80) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL,
  `book_isbn` varchar(80) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL,
...
-- Records of book
-- ----------------------------
INSERT INTO `book` VALUES (48, 10, '《朝花夕拾》', '鲁迅', 2, '/api/file/download/朝花夕拾.jpg', '清华大学', '第三版', '978-7-302-44068-8', 2, 0);
INSERT INTO `book` VALUES (49, 10, '《计算机网络》', '内尔戴尔', 1, '/api/file/download/计算机网络.jpg', '机械工业', '第八版', '3-564-19034-4', 0, 1);
INSERT INTO `book` VALUES (50, 10, '《数据库设计与原理》', '大卫奥哈拉论', 1, '/api/file/download/数据库设计与原理.jpg', '人民邮电', '第三版', '978-3-564-19034-4', 1, 1);
INSERT INTO `book` VALUES (51, 10, '《操作系统》', '兰德尔', 1, '/api/file/download/操作系统.jpg', '清华大学', '第五版', '9-4345-2904-543', 1, 1);
INSERT INTO `book` VALUES (52, 10, '《计算机组成原理》', '章邵辉', 1, '/api/file/download/计算机组成原理.jpg', '机械工业', '第四版', '3-534-2323-653', 2, 0);
INSERT INTO `book` VALUES (53, 10, '《C语言程序设计》', '苏小红', 1, '/api/file/download/C语言程序设计.jpg', '电子工业', '第三版', '8-329-34434-04334-4', 2, 0);
INSERT INTO `book` VALUES (54, 10, '《呐喊》', '鲁迅', 2, '/api/file/download/呐喊.jpg', '清华大学', '微课版', '8-329-36836-4', 0, 1);
INSERT INTO `book` VALUES (55, 10, '《啊Q正传》', '鲁迅', 2, '/api/file/download/啊Q正传.jpg', '电子工业', '第五版', '978-7-232-98798-8', 2, 1);
INSERT INTO `book` VALUES (57, 10, '《线性代数》', '迈尔斯', 1, '/api/file/download/线性代数.jpg', '清华大学', '第八版', '7-434-43094-45', 0, 0);
INSERT INTO `book` VALUES (59, 10, '《彷徨》', '鲁迅', 2, '/api/file/download/彷徨.jpg', '机械工业', '第三版', '34-9239-34590-3', 0, 0);
INSERT INTO `book` VALUES (66, 10, '《数据结构》', '王红梅', 1, '/api/file/download/数据结构.jpg', '清华大学', '第3版', '45-25345-343-22', 1, 0);
INSERT INTO `book` VALUES (67, 10, '《离散数学》', '马鹏程', 1, '/api/file/download/离散数学.jpg', '机械工业', '第5版', '43-2323-23-232', 1, 0);
...
CREATE TABLE `booktag`  (
  `book_isbn` varchar(80) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NOT NULL,
  `book_kind` tinyint NULL DEFAULT NULL,
...
CREATE TABLE `borrow`  (
  ...
  `should_date` datetime NULL DEFAULT NULL,
  `return_date` datetime NULL DEFAULT NULL,
  `borrow_state` tinyint NULL DEFAULT NULL,
  PRIMARY KEY (`user_id`, `borrow_date`, `book_id`) USING BTREE
...
CREATE TABLE `chat`  (
  ...
  `chat_content` varchar(200) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NOT NULL,
...
INSERT INTO `chat` VALUES (10, 11, '2023-04-19 21:47:39', 0, '不好意思，我周末没空');
INSERT INTO `chat` VALUES (11, 10, '2023-04-19 21:46:21', 0, '1');
INSERT INTO `chat` VALUES (11, 10, '2023-04-19 21:46:39', 0, '你好，周末有空吗？\n');
...
CREATE TABLE `code`  (
  `code_id` char(6) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NOT NULL,
  `book_id` bigint NOT NULL,
...
INSERT INTO `contact` VALUES (10, 11, 1, '2023-04-19 21:47:39');
INSERT INTO `contact` VALUES (11, 10, 2, '2023-04-19 21:46:39');
...
CREATE TABLE `user`  (
  ...
  `user_mail` varchar(30) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL,
  `user_phone` varchar(80) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL,
  `user_photo` varchar(80) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL,
  `user_bookhouse` varchar(80) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL,
  `user_address` varchar(80) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL,
  `user_kind` tinyint NULL DEFAULT 0,
  `user_longitude` decimal(20, 15) NULL DEFAULT NULL,
  `user_latitude` decimal(20, 15) NULL DEFAULT NULL,
...
INSERT INTO `user` VALUES (10, '风来花去', '123', '333@qq.com', NULL, '/api/file/download/e0db79a54063.jpg', '饮冰室', '广东阳江', 0, 50.000000000000000, 50.000000000000000);
INSERT INTO `user` VALUES (11, 'neo1', '123', 'admin@qq.com', NULL, '/api/file/download/55f8adbe-0774-47a9-8eb4-e903e14e3bf7.jpg', NULL, NULL, 0, NULL, NULL);
